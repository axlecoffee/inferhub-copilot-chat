...
declare module 'vscode' {
	...
	*/
	 ...
	 * typically streams before the final response. VS Code displays these in
	 * a collapsible thinking section in Copilot Chat.
	 *
	 * Stable in VS Code 1.130+.
	 */
	export class LanguageModelThinkingPart {
		/**
		 * The thinking/reasoning text content. Can be a single string or an
		 * array of strings that will be concatenated for display.
		 */
		value: string | string[];
		...
		/**
		 * @param value The thinking/reasoning text content.
